...
import com.jg.wx.core.type.UserTypeEnum;
...
import com.jg.wx.core.util.bcrypt.BCryptPasswordEncoder;
import com.jg.wx.domain.DtsUser;
import com.jg.wx.hy.annotation.LoginUser;
import com.jg.wx.hy.constant.WxConstant;
import com.jg.wx.hy.dao.UserInfo;
import com.jg.wx.hy.dao.UserToken;
import com.jg.wx.hy.dao.WxLoginInfo;
import com.jg.wx.hy.service.CaptchaCodeManager;
import com.jg.wx.hy.service.UserTokenManager;
import com.jg.wx.hy.util.IpUtil;
...
import static com.jg.wx.hy.util.WxResponseCode.AUTH_CAPTCHA_FREQUENCY;
import static com.jg.wx.hy.util.WxResponseCode.AUTH_CAPTCHA_UNMATCH;
import static com.jg.wx.hy.util.WxResponseCode.AUTH_CAPTCHA_UNSUPPORT;
import static com.jg.wx.hy.util.WxResponseCode.AUTH_INVALID_ACCOUNT;
import static com.jg.wx.hy.util.WxResponseCode.AUTH_INVALID_MOBILE;
import static com.jg.wx.hy.util.WxResponseCode.AUTH_MOBILE_REGISTERED;
import static com.jg.wx.hy.util.WxResponseCode.AUTH_MOBILE_UNREGISTERED;
import static com.jg.wx.hy.util.WxResponseCode.AUTH_NAME_REGISTERED;
import static com.jg.wx.hy.util.WxResponseCode.AUTH_OPENID_BINDED;
import static com.jg.wx.hy.util.WxResponseCode.AUTH_OPENID_UNACCESS;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        String username = JacksonUtil.parseString(body, WxConstant.WX_USER_USERNAME);
        String password = JacksonUtil.parseString(body, WxConstant.WX_USER_PASSWORD);
        ...
        if (!encoder.matches(password, user.getPassword())) {
            // 错误的密码打印到日志中作为提示也无妨
            logger.error("账户登录 ,错误密码：{},{}", password, AUTH_INVALID_ACCOUNT.desc());
